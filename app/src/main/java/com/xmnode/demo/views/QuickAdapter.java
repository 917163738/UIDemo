...
import static com.xmnode.demo.views.BaseAdapterHelper.get;
...
public abstract class QuickAdapter<T> extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (getItemViewType(position) == 0) {
			final BaseAdapterHelper helper = get(context, convertView, parent,
	...
	public void addRefreash(T elem) {
		data.add(elem);
	...
	public void addAllRefreash(List<T> elem) {
		data.addAll(elem);
		notifyDataSetChanged();
	}
	...
	public void setItemCheck(ItemCheck itemCheck, int position) {
		itemCheck.itemCheck(position);
	}
