...
public class BaseAdapterHelper {
    ...
    public BaseAdapterHelper setText(int viewId, SpannableStringBuilder value) {
        TextView view = retrieveView(viewId);
        view.setText(value);
        return this;
    }
    ...
    // * It uses Square's Picasso library to download the image asynchronously
    // and put the result into the ImageView.<br/>
